(function (exports, $) {
  ...
  AppConfig = {
    idle: 0,
    level: 0,
    message: 'Utilizamos cookies propias y de terceros para realizar medici&#243;n de la navegaci&#243;n de los usuarios. Si contin&#250;as navegando, consideramos que aceptas su uso.',
	cancel: 'Acepto',
	changeSettings: 'Ajustes de cookies',
	linkText: 'Puedes cambiar la configuraci&#243;n u obtener m&#225;s informaci&#243;n aqu&#237;',
    functionalList: {
        'strict': {
          'will' : ['Recuerda los producto en tu cesta'],
          'willnot': ['Enviar informaci&oacute;n a otras webs', 'Recodar accesos al area de ususario', 'Mejorar la experiencia de navegaci&oacute;n']
        },
        'functional': {
          'will' : ['Recuerda los producto en tu cesta', 'Recodar los accesos al area de ususario','Mejorar la experiencia de navegaci&oacute;n'],
          'willnot': ['Enviar informaci&oacute;n a otras p&aacute;ginas, as&iacute; se te puede anunciar informaci&oacute;n relavante para ti']
        },
        'targeting': {
          'will' : ['Recuerda los producto en tu cesta', 'Recodar los accesos al area de ususario','Mejorar la experiencia de navegaci&oacute;n','Enviar informaci&oacute;n a otras p&aacute;ginas, as&iacute; se te puede anunciar informaci&oacute;n relavante para ti'],
          'willnot': []
        }
      }
  };
  ...
  EU.CookiePreferenceUI = (function () {
    ...
    function createExtenedPanel() {
      ...
      if (!p) {
        ...
        panel.innerHTML = '<div id="cookie-ext-panel">' +
          '<div id="cookie-info">' +
            '<h1>Selecciona tu nivel cookies</h1>' +
            '<p></p>' +
            '<div id="cookie-selection">' +
              '<h2></h2>' +
              '<div id="cokkie-options">' +
                  '<label for="strict"><span>Estrictamente necesario y mejoras de navegaci&oacute;n</span>' +
                    '<input type="checkbox" id="strict" name="cookie-opt" value="1"/>' +
                  '</label>' +
                  '<label for="functional"><span>Funcional</span>' +
                    '<input type="checkbox" id="functional" name="cookie-opt" value="2"/>' +
                  '</label>' +
                  '<label for="targeting"><span>Focalizado</span>' +
            ...
            '<div class="clearfix">&nbsp;</div>' +
            '<div id="c-toolbar">' +
              '<input type="button" id="COOKIE_CANCEL" value="Cancelar"/>' +
              '<input type="button" id="COOKIE_SAVE" value="Aceptar"/>' +
            '</div>' +
            '<div class="clearfix">&nbsp;</div>' +
          '</div>' +
        '</div>';
    ...
    listFeatures = function(n) {
      var i, j, will, willnot, willWraper = '<h3>Esta p&aacute;gina autoriza:</h3><ul>', willNotWraper = '<h3>Esta p&aacute;gina no autoriza:</h3><ul>';
